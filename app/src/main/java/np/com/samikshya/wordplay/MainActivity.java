package np.com.samikshya.wordplay;
...
import np.com.samikshya.wordplay.adapters.CharactersAdapter;

public class MainActivity extends AppCompatActivity implements View.OnClickListener {

    private String[] words = {"mango", "banana", "orange", "grapes", "apple", "gauva"};
